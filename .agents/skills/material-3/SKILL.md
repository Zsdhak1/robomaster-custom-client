...
## WOD Client Repo Shortcut

When auditing or extending this repository, read `feature_spec.md` → "新 Agent 接手摘要" and the `v0.1.1` Material 3 block first. Treat v0.1.1 as the completed MD3 baseline, then review only the changed surfaces unless the user asks for a full audit.
