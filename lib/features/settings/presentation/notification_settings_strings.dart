...
const notificationRespawnSubtitle = '根据血量清零后的恢复时间区分普通免费、加速免费、付费和方式不确定';
...
const notificationUncertainBehaviorDescription =
...
const notificationNormalProgressRateDescription = '用于计算普通免费复活的预期完成时间';
const notificationAcceleratedProgressRate = '加速免费复活进度速度';
const notificationAcceleratedProgressRateDescription = '用于计算加速免费复活的预期完成时间';
const notificationLowBaseThreshold = '基地低血量阈值';
const notificationLowBaseThresholdDescription =
...
String uncertainBuybackLabel(UncertainBuybackBehavior value) => switch (value) {
  ...
  UncertainBuybackBehavior.suspected => '显示方式不确定',
};
